...
import {IContacts, IContactsFields, IFooterFields} from "contentfuls/types/contentful";
    ...
    <div className={cn("section", styles.section)}>
      <div className={cn("container", styles.container)}>
        <div className={styles.main_content}>
          ...
          <div>
            <p className={cn("body-2-bold")}>{dataFooter && dataFooter.action}</p>
            <div className={styles.newsletter}>
              <input
                ...
                type={'email'}
              />
              <button className={cn("button")}>{dataFooter && dataFooter.button}</button>
            </div>
          </div>
        </div>
            ...
            <div className={styles.links}>
              {dataContacts && dataContacts.map((item, index) => (
                <button
                  ...
                  className={cn("button-small", styles.button)}
                >
                  {`${item.fields.title} ${item.fields.description}`}
                </button>
              ))}
            </div>
          </div>
